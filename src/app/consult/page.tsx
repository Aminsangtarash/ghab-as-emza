    ...
    <>
      <section className="relative overflow-hidden bg-navy-deep">
        <div className="relative mx-auto w-full max-w-5xl px-4 pb-12 pt-16 sm:px-6 sm:pb-16 sm:pt-20">
          <p className="text-sm font-medium text-gold">ثبت درخواست</p>
          <h1 className="mt-2 font-heading text-3xl font-bold text-white sm:text-4xl">
            مشاوره حقوقی، مرحله‌به‌مرحله
          </h1>
          <span className="mt-3 block h-1 w-14 rounded-full bg-gold" />
          <p className="mt-4 max-w-2xl text-sm leading-7 text-white/75 sm:text-base">
            مشاوره متنی و تماس تصویری داخل سایت انجام می‌شود؛ تماس تلفنی را دفتر هماهنگ می‌کند. اگر وکیل
            انتخاب نکنید، اپراتور متخصص مناسب را مشخص می‌کند.
          </p>
        </div>
      </section>
