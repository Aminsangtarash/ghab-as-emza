        ...
        >
          <CardContent className="flex h-full flex-col items-center p-7 text-center">
            <span
              className={
                index % 2 === 1
                  ? "mb-5 flex size-16 items-center justify-center rounded-2xl bg-gold/15 text-gold"
                  : "mb-5 flex size-16 items-center justify-center rounded-2xl bg-navy/5 text-navy"
              }
            >
              <ServiceIcon name={category.icon} className="size-8" />
            </span>
